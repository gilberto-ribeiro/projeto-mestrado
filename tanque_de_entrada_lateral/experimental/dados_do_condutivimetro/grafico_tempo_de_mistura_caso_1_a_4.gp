...
'caso_3_N_600rpm_beta_15/caso_3_eletrodo_1_fundo.dat' u ($1/60):2 t 'Eletrodo 1: Fundo [C. 3]' w l lt 4 dt 1, \
'caso_3_N_600rpm_beta_15/caso_3_eletrodo_2_topo.dat' u ($1/60):2 t 'Eletrodo 2: Topo [C. 3]' w l lt 4 dt 2
set terminal pdfcairo font 'courier'
set output 'fig_gr_tempo_de_mistura_caso_1_a_4.pdf'
replot
set output